...
class SpeechesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create speech" do
    assert_difference("Speech.count") do
      post speeches_url, params: { speech: { description: @speech.description, hour: @speech.hour, time: @speech.time } }
    end
  ...
  test "should update speech" do
    patch speech_url(@speech), params: { speech: { description: @speech.description, hour: @speech.hour, time: @speech.time } }
